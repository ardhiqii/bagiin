...
{"merchant":"nama tempat makan/toko","date":"YYYY-MM-DD","items":[{"name":"nama item","price":harga}],"subtotal":N,"tax":N,"service":N,"total":N}
Rules:
...
- price dalam Rupiah integer (tanpa 'Rp', tanpa titik)
- tax = PPN/PB1, service = service charge/SC (0 kalau tidak ada)
- subtotal = jumlah sebelum pajak; total = yang dibayar
