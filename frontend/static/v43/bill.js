...
function renderGuestView(data, me) {
  ...
  appEl.innerHTML = `
    ...
    <div class="sticky-bar"><div class="sticky-inner" style="flex-direction:column;align-items:stretch;gap:10px;">
      ...
      <div id="my-breakdown" class="muted" style="display:flex;justify-content:space-between;font-size:12px;flex:none;${taxServiceTotal(data) > 0 ? "" : "display:none;"}">
        <span>Item <span class="money-sm" id="my-sub">${fmt(bdGuest.sub)}</span></span>
        <span>Pajak & service <span class="money-sm" id="my-tax">${fmt(bdGuest.tax)}</span></span>
      </div>
      ${iAmPayer
...
function renderCreatorPick(data) {
  ...
  appEl.innerHTML = `
    ...
    <div class="sticky-bar"><div class="sticky-inner" style="flex-direction:column;align-items:stretch;gap:10px;">
      ...
      <div id="my-breakdown" class="muted" style="display:flex;justify-content:space-between;font-size:12px;flex:none;${taxServiceTotal(data) > 0 ? "" : "display:none;"}">
        <span>Item <span class="money-sm" id="my-sub">${fmt(computeMyBreakdown(data, mySel).sub)}</span></span>
        <span>Pajak & service <span class="money-sm" id="my-tax">${fmt(computeMyBreakdown(data, mySel).tax)}</span></span>
      </div>
