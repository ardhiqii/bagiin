...
import { AccountRows, AppFrame, ErrorState, ShareDialogContent, Topbar } from "../../components/layout/AppShell";
...
export function BillScreen({ billId, identity, onIdentity }: { billId: string; identity: Identity | null; onIdentity: (identity: Identity) => void }) {
