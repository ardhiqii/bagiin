...
- Chain OCR sekarang membuang dua model OpenRouter yang terbukti selalu 403, tidak mengulang request Gemini untuk status retryable, membatasi budget satu request menjadi 40 detik dengan margin setup dan overshoot terukur, serta menyisakan slice untuk kandidat fallback berikutnya. Kontrak normalisasi, MIME/downscale, quantity, duplicate rows, dan perhitungan nominal dipertahankan.
